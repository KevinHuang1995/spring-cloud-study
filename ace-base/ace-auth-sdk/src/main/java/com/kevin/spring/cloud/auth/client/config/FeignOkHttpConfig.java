package com.kevin.spring.cloud.auth.client.config;


import com.kevin.spring.cloud.auth.client.interceptor.OkHttpTokenInterceptor;
import feign.Feign;
...
public class FeignOkHttpConfig {
    ...
    @Autowired
    private OkHttpTokenInterceptor okHttpTokenInterceptor;
